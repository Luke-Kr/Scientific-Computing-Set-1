...
def show_times(history):
    ...
    im = axs[0, 0].imshow(history[0], cmap="inferno", origin="lower", extent=[0, 1, 0, 1])
    axs[0, 0].set_title("t = 0")
    axs[0, 0].set_xlabel("x")
    axs[0, 0].set_ylabel("y")

    axs[0, 1].imshow(history[1], cmap="inferno", origin="lower", extent=[0, 1, 0, 1])
    axs[0, 1].set_title("t = 0.001")
    axs[0, 1].set_xlabel("x")
    axs[0, 1].set_ylabel("y")

    axs[0, 2].imshow(history[10], cmap="inferno", origin="lower", extent=[0, 1, 0, 1])
    axs[0, 2].set_title("t = 0.01")
    axs[0, 2].set_xlabel("x")
    axs[0, 2].set_ylabel("y")

    axs[1, 0].imshow(history[100], cmap="inferno", origin="lower", extent=[0, 1, 0, 1])
    axs[1, 0].set_title("t = 0.1")
    axs[1, 0].set_xlabel("x")
    axs[1, 0].set_ylabel("y")

    axs[1, 1].imshow(history[-1], cmap="inferno", origin="lower", extent=[0, 1, 0, 1])
...
if __name__ == '__main__':
    ...
    history = np.load("data/TDDE_(100x100)_1000000.npy")  # Shape: (101, 101, 101)
